...
public class User implements UserInterface {
    ...
    public void watchVideo(int videoId) {
        receivedVideos.remove((Integer) videoId);
    }
    ...
    @Override
    public boolean isFollowing(UserInterface user) { return following.containsKey(user.getId()); }
